...
import TrainerStudentChat from './pages/student/TrainerStudentChat';
    ...
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/student-chat" element={<ProtectedRoute allowedRoles={['student']}><PortalLayout /></ProtectedRoute>}>
             <Route index element={<TrainerStudentChat/>} />
           </Route>
