            ...
            <motion.div {...fadeUp} transition={{ delay: 0.2 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                <div className="card" style={{ padding: 20, display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
                  <span style={{ fontSize: '1.8rem', color: 'var(--primary)', display: 'inline-flex', marginBottom: 6 }}><FiMail /></span>
                  <h4 style={{ fontWeight: 600, margin: '4px 0' }}>Email</h4>
                  <p style={{ color: 'var(--gray-500)', fontSize: 14 }}>info@elevateiq.com</p>
                </div>
                <div className="card" style={{ padding: 20, display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
                  <span style={{ fontSize: '1.8rem', color: 'var(--primary)', display: 'inline-flex', marginBottom: 6 }}><FiPhone /></span>
                  <h4 style={{ fontWeight: 600, margin: '4px 0' }}>Phone</h4>
                  <p style={{ color: 'var(--gray-500)', fontSize: 14 }}>+1 (555) 123-4567</p>
                </div>
                <div className="card" style={{ padding: 20, display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
                  <span style={{ fontSize: '1.8rem', color: 'var(--primary)', display: 'inline-flex', marginBottom: 6 }}><FiMapPin /></span>
                  <h4 style={{ fontWeight: 600, margin: '4px 0' }}>Address</h4>
                  <p style={{ color: 'var(--gray-500)', fontSize: 14 }}>123 Innovation Drive, Tech City, TC 10001</p>
                </div>
                <div className="card" style={{ padding: 20, display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
                  <span style={{ fontSize: '1.8rem', color: 'var(--primary)', display: 'inline-flex', marginBottom: 6 }}><FiClock /></span>
                  <h4 style={{ fontWeight: 600, margin: '4px 0' }}>Working Hours</h4>
